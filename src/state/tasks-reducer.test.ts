...
import { addTodoListsAC, removeTodolistsAC } from './todolists-reduser'
...
test('status of specified task should be title', () => {
    ...
    const action = changeTitleStatusAC('2', 'tutu', 'todolistId2')

    const endState = tasksReducer(startState, action)

    expect(endState['todolistId2'][1].title).toBe('tutu')
